'' @script EnviaAfip 3.5  06-10-2020 Consumis=dor Final Stenfar
	...
	stop
				...
				' Muestro los errores
					...
					If WSFACT.Resultado = "A" and CAE <> "" Then 
						...
						senddebug ("Factura Electrónica SA - Numero: " & CStr(punto_vta ) &  WSFACT.CbteNro) :senddebug ("Cae   : "& WSFACT.CAE)
...
'*******************************************************************************
				...
				' Obtiene la posición de IVA.	
					...
					If (oPosicion.PosicionImpuesto.Codigo = "EX") Then		
...
stop
                   ...
                   If xProdalsa or xZSA or xEgramar Then
